...
This is the github repository for our paper titled RNAseq analysis of Stenotrophomonas maltophilia strains isolated from CF patients. Please make use of our work, and if you do, please cite as follows:

>  Eckstrom, Korin. "<PAPER TITLE>". *<JOURNAL TITLE>* <VOLUME>, no. <NUMBER> (<YEAR>): <PAGES>. doi: https://dx.doi.org/xxxxxx.
